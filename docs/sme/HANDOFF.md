...
- **Show measured-savings invoices as proof-first, not balance-only:** include pre/post value, tax-rate assumption, corrected bill/order/refund proof, exemption adjustment, fee percentage/cap, due date, and receipt path. *(collections-ar col-01, col-03, col-10-col-13)*
- **Treat ACH/card capture at signing as a consented delayed-charge option:** the Owner must see amount formula, trigger, advance notice, revocation path, descriptor/receipt, and post-outcome invoice fallback. *(collections-ar col-07, col-16, col-18-col-19)*
- **Give invoice disputes named reasons and Owner-visible resolution paths:** rate year, exemptions, assessed versus taxable value, partial reduction, refund timing, escrow felt-win gap, fee percentage, minimum fee, and recurrence misunderstanding. *(collections-ar col-10-col-13, col-20)*
- **Use private-vendor dunning and fee-survival copy:** reminders must not look like county tax collection, and the mid-sale edge stays a fee-agreement clause that survives transfer or attaches at filing. *(collections-ar col-14-col-15, col-17, col-21-col-22)*
...
- **Store ACH/card authorization as an auditable payment object:** receiver identity, account/card validation, WEB/PPD/CCD or stored-credential classification, max/formula amount, notice timing, revocation, authorization copy, descriptor, and receipt. *(collections-ar col-07, col-16, col-18-col-19)*
- **Build the measured-savings calculator from official proof:** original notice, final order/settlement, corrected roll or bill, refund notice, taxing-unit rate source, exemption adjustment, and calculation worksheet. *(collections-ar col-10-col-13, col-20)*
- **Model collections as states with evidence and channel rules:** invoice due, reminder, dispute, AP reroute, written demand, agency/attorney handoff, write-off, and collection-cost/interest accrual need logs and compliance guards. *(collections-ar col-14-col-15, col-21, col-23-col-24)*
- **Validate entity payor and signer risk before invoicing:** deeded owner, authorized signer, AP delegate, authority proof, signer warranty, optional guaranty, and counsel-approved security language need separate fields. *(collections-ar col-17, col-25-col-26)*
...
- Collections/AR incumbent practice is now sourced in `collections-ar` Pass 1/2; empirical bad-debt and dispute-rate benchmarks remain NEEDS VERIFICATION on that seat. Mid-sale stays a fee-survival clause, not a seat. *(collections-ar col-08-col-09, col-17)*
